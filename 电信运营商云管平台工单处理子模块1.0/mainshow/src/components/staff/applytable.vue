<template>
  ...
  <div style="margin-left:-50%;color:black;font-weight:bolder">物理机资源</div>
    ...
    <!-- 已添加物理机资源表 -->
    <el-table :data="tabledata2" style="margin-left:30%">
    <el-table-column property="cpu" label="CPU(核)" width="150"></el-table-column>
    <el-table-column property="memory" label="内存(G)" width="200"></el-table-column>
   ...
   <!-- 虚拟机资源填写表单 -->
    <el-form :inline="true" :model="tabledata2" class="demo-form-inline" style="margin-left:-20px">
        <el-form-item label="CPU(核)">
          <el-input v-model="tabledata2.cpu" placeholder="CPU(核)"></el-input>
        </el-form-item>
    ...
    <el-form :inline="true" :model="tabledata2" class="demo-form-inline" style="margin-left:20px">
      <el-form-item label="存储(G)">
        <el-input v-model="tabledata2.storage" placeholder="存储(G)"></el-input>
      </el-form-item>
      <el-form-item label="操作系统">
        <el-select v-model="tabledata2.win" placeholder="操作系统">
          <el-option label="windows" value="windows"></el-option>
          <el-option label="linux" value="linux"></el-option>
        </el-select>
      </el-form-item>
    </el-form>
    <el-form ref="form" :model="tabledata2" label-position=right label-width=430px>
  ...
  methods: {
    ...
    // 点击selection多选框
     handleSelectionChange(data) {
      ...
      this.length=this.$refs.multipleTable.selection;
